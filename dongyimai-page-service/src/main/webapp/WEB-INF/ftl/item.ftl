...
<head>
	...
	<script type="application/javascript" src="js/controller/itempageController.js"></script>
	<script>
		var itemList = [
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd>
									<a href="javascript:;" ng-click="addSpec('${spec.attributeName}','${value}')"
